...
get '/' do
  ...
  p1 = "<p>There are <span class=\"special\">#{query}</span> reports to dig into!</p>"
...
get '/histogram' do
  ...
  image = "<img src=\"#{url}\" alt=\"A sweet google chart, that you're not seeting, unfortunately.\" title=\"Histogram\" />"

  p1 = '<p class="notes">This is a histogram of all of the data.</p>'
